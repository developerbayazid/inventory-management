<div style="max-width: 100%;background: #ffffff;padding: 30px;border-radius: 8px;" class="invoice-container">
        ...
        <div style="margin-top: 30px;width: 40%;margin-left: auto;" class="totals">
            <table style="width: 100%;border-collapse: collapse;margin-top: 30px;">
                <tr>
                    <td style="border: 1px solid #e0e0e0;text-align: right;padding: 8px 12px;font-weight: bold">Sub Total</td>
                    <td style="border: 1px solid #e0e0e0;text-align: right; padding: 8px 12px; font-weight: bold;" class="text-right">${{ $purchase->total }}</td>
                </tr>
                <tr>
                    <td style="border: 1px solid #e0e0e0;text-align: right;padding: 8px 12px;font-weight: bold">Discount</td>
                    <td style="border: 1px solid #e0e0e0;text-align: right;padding: 8px 12px; font-weight: bold;" class="text-right">${{ $purchase->discount }}</td>
                </tr>
                <tr>
                    <td style="border: 1px solid #e0e0e0;text-align: right;padding: 8px 12px;font-weight: bold">Total</td>
                    <td style="border: 1px solid #e0e0e0;text-align: right;padding: 8px 12px; font-weight: bold;" class="text-right">${{ $purchase->net_total }}</td>
                </tr>
            </table>
        </div>
